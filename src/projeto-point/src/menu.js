const list = [
    ...
    {
        title: "🍕🍕 Pizza de 2 sabores🍕🍕",
        rows: [
            {
                title: "Média - 2 sabores",
                description: "Ao escolher essa opção você poderá escolher dois sabores para sua pizza média",
            },
            {
                title: "Grande - 2 sabores",
                description: "Ao escolher essa opção você poderá escolher dois sabores para sua pizza grande",
            }
        ]
    },
    {
